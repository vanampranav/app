      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (user == null && !authService.isSdkSignedIn)
              Text(
              ...
              Text(
                'SDK signed in: ${authService.isSdkSignedIn} (uid: ${authService.sdkUid ?? "null"})\n'
                'Profile: ${user == null ? "not loaded" : "email ${user.email}, admin ${user.isAdmin}, role \"${user.role}\""}'
                '${authService.lastError != null ? "\nFirestore error: ${authService.lastError}" : ""}',
